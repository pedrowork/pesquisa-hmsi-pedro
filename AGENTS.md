# Pesquisa - Guia para Agentes

**Responda sempre em Português.**
**Sempre veja qual a data atual em caso de pesquisa**
**NUNCA FAÇA COMMIT SEM AUTORIZAÇÃO PREVIA MESMO QUE VOCÊ JÁ TENHA FEITO ALGUM COMMIT ANTES**

## Idioma do Código

⚠️ **IMPORTANTE**: Todo o código (classes, métodos, variáveis, strings, eventos, etc) deve ser escrito em **INGLÊS**.
